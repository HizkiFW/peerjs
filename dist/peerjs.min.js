...
},{"js-binarypack":"lHOc","./adapter":"sXtV"}],"8WOs":[function(require,module,exports) {
...
},{"./util":"T9kO"}],"9ZRY":[function(require,module,exports) {
"use strict";var e,r,n,o,t,a,i;Object.defineProperty(exports,"__esModule",{value:!0}),function(e){e.Open="open",e.Stream="stream",e.Data="data",e.Close="close",e.Error="error"}(e=exports.ConnectionEventType||(exports.ConnectionEventType={})),function(e){e.Data="data",e.Media="media"}(r=exports.ConnectionType||(exports.ConnectionType={})),function(e){e.Open="open",e.Close="close",e.Connection="connection",e.Call="call",e.Disconnected="disconnected",e.Error="error"}(n=exports.PeerEventType||(exports.PeerEventType={})),function(e){e.BrowserIncompatible="browser-incompatible",e.Disconnected="disconnected",e.InvalidID="invalid-id",e.InvalidKey="invalid-key",e.Network="network",e.PeerUnavailable="peer-unavailable",e.SslUnavailable="ssl-unavailable",e.ServerError="server-error",e.SocketError="socket-error",e.SocketClosed="socket-closed",e.UnavailableID="unavailable-id",e.WebRTC="webrtc"}(o=exports.PeerErrorType||(exports.PeerErrorType={})),function(e){e.Binary="binary",e.BinaryUTF8="binary-utf8",e.JSON="json"}(t=exports.SerializationType||(exports.SerializationType={})),function(e){e.Message="message",e.Disconnected="disconnected",e.Error="error",e.Close="close"}(a=exports.SocketEventType||(exports.SocketEventType={})),function(e){e.Heartbeat="HEARTBEAT",e.Candidate="CANDIDATE",e.Offer="OFFER",e.Answer="ANSWER",e.Open="OPEN",e.Error="ERROR",e.IdTaken="ID-TAKEN",e.InvalidKey="INVALID-KEY",e.Leave="LEAVE",e.Expire="EXPIRE"}(i=exports.ServerMessageType||(exports.ServerMessageType={}));
},{}],"HCdX":[function(require,module,exports) {
"use strict";var e=this&&this.__assign||function(){return(e=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var o in t=arguments[n])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o]);return e}).apply(this,arguments)},t=this&&this.__awaiter||function(e,t,n,r){return new(n||(n=Promise))(function(o,a){function i(e){try{c(r.next(e))}catch(t){a(t)}}function s(e){try{c(r.throw(e))}catch(t){a(t)}}function c(e){e.done?o(e.value):new n(function(t){t(e.value)}).then(i,s)}c((r=r.apply(e,t||[])).next())})},n=this&&this.__generator||function(e,t){var n,r,o,a,i={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return a={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(a[Symbol.iterator]=function(){return this}),a;function s(a){return function(s){return function(a){if(n)throw new TypeError("Generator is already executing.");for(;i;)try{if(n=1,r&&(o=2&a[0]?r.return:a[0]?r.throw||((o=r.return)&&o.call(r),0):r.next)&&!(o=o.call(r,a[1])).done)return o;switch(r=0,o&&(a=[2&a[0],o.value]),a[0]){case 0:case 1:o=a;break;case 4:return i.label++,{value:a[1],done:!1};case 5:i.label++,r=a[1],a=[0];continue;case 7:a=i.ops.pop(),i.trys.pop();continue;default:if(!(o=(o=i.trys).length>0&&o[o.length-1])&&(6===a[0]||2===a[0])){i=0;continue}if(3===a[0]&&(!o||a[1]>o[0]&&a[1]<o[3])){i.label=a[1];break}if(6===a[0]&&i.label<o[1]){i.label=o[1],o=a;break}if(o&&i.label<o[2]){i.label=o[2],i.ops.push(a);break}o[2]&&i.ops.pop(),i.trys.pop();continue}a=t.call(e,i)}catch(s){a=[6,s],r=0}finally{n=o=0}if(5&a[0])throw a[1];return{value:a[0]?a[1]:void 0,done:!0}}([a,s])}}},r=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var a=r(require("reliable")),i=require("./util"),s=o(require("./logger")),c=require("./adapter"),l=require("./enums"),d=function(){function r(){this.pcs={data:{},media:{}},this.queue=[],this._idPrefix="pc_"}return r.prototype.startConnection=function(e,t){var n=this._getPeerConnection(e,t);if(e.peerConnection=n,e.type===l.ConnectionType.Media&&t._stream&&this._addTracksToConnection(t._stream,n),t.originator){if(e.type===l.ConnectionType.Data){var r=e,o={};i.util.supports.sctp||(o={reliable:t.reliable});var a=n.createDataChannel(r.label,o);r.initialize(a)}this._makeOffer(e)}else this.handleSDP("OFFER",e,t.sdp)},r.prototype._getPeerConnection=function(e,t){this.pcs[e.type]||s.default.error(e.type+" is not a valid connection type. Maybe you overrode the `type` property somewhere."),this.pcs[e.type][e.peer]||(this.pcs[e.type][e.peer]={});var n,r=this.pcs[e.type][e.peer];return t.pc&&(n=r[t.pc]),n&&"stable"===n.signalingState||(n=this._startPeerConnection(e)),n},r.prototype._startPeerConnection=function(e){s.default.log("Creating RTCPeerConnection.");var t=this._idPrefix+i.util.randomToken(),n={};e.type!==l.ConnectionType.Data||i.util.supports.sctp?e.type===l.ConnectionType.Media&&(n={optional:[{DtlsSrtpKeyAgreement:!0}]}):n={optional:[{RtpDataChannels:!0}]};var r=new c.RTCPeerConnection(e.provider.options.config,n);return this.pcs[e.type][e.peer][t]=r,this._setupListeners(e,r),r},r.prototype._setupListeners=function(e,t){var n=this,r=e.peer,o=e.connectionId,a=e.type,c=e.provider;s.default.log("Listening for ICE candidates."),t.onicecandidate=function(e){e.candidate&&(s.default.log("Received ICE candidates for:",r),c.socket.send({type:l.ServerMessageType.Candidate,payload:{candidate:e.candidate,type:a,connectionId:o},dst:r}))},t.oniceconnectionstatechange=function(){switch(t.iceConnectionState){case"failed":s.default.log("iceConnectionState is failed, closing connections to "+r),e.emit(l.ConnectionEventType.Error,new Error("Negotiation of connection to "+r+" failed.")),e.close();break;case"closed":s.default.log("iceConnectionState is closed, closing connections to "+r),e.emit(l.ConnectionEventType.Error,new Error("Negotiation of connection to "+r+" failed.")),e.close();break;case"disconnected":s.default.log("iceConnectionState is disconnected, closing connections to "+r);break;case"completed":t.onicecandidate=i.util.noop}},t.onicechange=t.oniceconnectionstatechange,s.default.log("Listening for data channel"),t.ondatachannel=function(e){s.default.log("Received data channel");var t=e.channel;c.getConnection(r,o).initialize(t)},s.default.log("Listening for remote stream"),t.ontrack=function(e){s.default.log("Received remote stream");var t=e.streams[0],a=c.getConnection(r,o);if(a.type===l.ConnectionType.Media){var i=a;n._addStreamToMediaConnection(t,i)}}},r.prototype.cleanup=function(e){s.default.log("Cleaning up PeerConnection to "+e.peer);var t=e.peerConnection;if(t){var n="closed"!==t.signalingState,r=!1;if(e.type===l.ConnectionType.Data){var o=e.dataChannel;r=o.readyState&&"closed"!==o.readyState}(n||r)&&(t.close(),e.peerConnection=null)}},r.prototype._makeOffer=function(r){return t(this,void 0,Promise,function(){var t,o,c,d,p,u;return n(this,function(n){switch(n.label){case 0:t=r.peerConnection,n.label=1;case 1:return n.trys.push([1,7,,8]),[4,t.createOffer(r.options.constraints)];case 2:o=n.sent(),s.default.log("Created offer."),i.util.supports.sctp||r.type!==l.ConnectionType.Data||(d=r).reliable&&(o.sdp=a.higherBandwidthSDP(o.sdp)),r.options.sdpTransform&&"function"==typeof r.options.sdpTransform&&(o.sdp=r.options.sdpTransform(o.sdp)||o.sdp),n.label=3;case 3:return n.trys.push([3,5,,6]),[4,t.setLocalDescription(o)];case 4:return n.sent(),s.default.log("Set localDescription:",o,"for:"+r.peer),c={sdp:o,type:r.type,connectionId:r.connectionId,metadata:r.metadata,browser:i.util.browser},r.type===l.ConnectionType.Data&&(c=e({},c,{label:(d=r).label,reliable:d.reliable,serialization:d.serialization})),r.provider.socket.send({type:l.ServerMessageType.Offer,payload:c,dst:r.peer}),[3,6];case 5:return"OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer"!=(p=n.sent())&&(r.provider.emitError(l.PeerErrorType.WebRTC,p),s.default.log("Failed to setLocalDescription, ",p)),[3,6];case 6:return[3,8];case 7:return u=n.sent(),r.provider.emitError(l.PeerErrorType.WebRTC,u),s.default.log("Failed to createOffer, ",u),[3,8];case 8:return[2]}})})},r.prototype._makeAnswer=function(e){return t(this,void 0,Promise,function(){var t,r,o,c;return n(this,function(n){switch(n.label){case 0:t=e.peerConnection,n.label=1;case 1:return n.trys.push([1,7,,8]),[4,t.createAnswer()];case 2:r=n.sent(),s.default.log("Created answer."),i.util.supports.sctp||e.type!==l.ConnectionType.Data||e.reliable&&(r.sdp=a.higherBandwidthSDP(r.sdp)),n.label=3;case 3:return n.trys.push([3,5,,6]),[4,t.setLocalDescription(r)];case 4:return n.sent(),s.default.log("Set localDescription:",r,"for:"+e.peer),e.provider.socket.send({type:l.ServerMessageType.Answer,payload:{sdp:r,type:e.type,connectionId:e.connectionId,browser:i.util.browser},dst:e.peer}),[3,6];case 5:return o=n.sent(),e.provider.emitError(l.PeerErrorType.WebRTC,o),s.default.log("Failed to setLocalDescription, ",o),[3,6];case 6:return[3,8];case 7:return c=n.sent(),e.provider.emitError(l.PeerErrorType.WebRTC,c),s.default.log("Failed to create answer, ",c),[3,8];case 8:return[2]}})})},r.prototype.handleSDP=function(e,r,o){return t(this,void 0,Promise,function(){var t,a,i;return n(this,function(n){switch(n.label){case 0:o=new c.RTCSessionDescription(o),t=r.peerConnection,s.default.log("Setting remote description",o),a=this,n.label=1;case 1:return n.trys.push([1,5,,6]),[4,t.setRemoteDescription(o)];case 2:return n.sent(),s.default.log("Set remoteDescription:"+e+" for:"+r.peer),"OFFER"!==e?[3,4]:[4,a._makeAnswer(r)];case 3:n.sent(),n.label=4;case 4:return[3,6];case 5:return i=n.sent(),r.provider.emitError(l.PeerErrorType.WebRTC,i),s.default.log("Failed to setRemoteDescription, ",i),[3,6];case 6:return[2]}})})},r.prototype.handleCandidate=function(e,r){return t(this,void 0,Promise,function(){var t,o,a;return n(this,function(n){switch(n.label){case 0:t=r.candidate,o=r.sdpMLineIndex,n.label=1;case 1:return n.trys.push([1,3,,4]),[4,e.peerConnection.addIceCandidate(new c.RTCIceCandidate({sdpMLineIndex:o,candidate:t}))];case 2:return n.sent(),s.default.log("Added ICE candidate for:"+e.peer),[3,4];case 3:return a=n.sent(),e.provider.emitError(l.PeerErrorType.WebRTC,a),s.default.log("Failed to handleCandidate, ",a),[3,4];case 4:return[2]}})})},r.prototype._addTracksToConnection=function(e,t){if(s.default.log("add tracks from stream "+e.id+" to peer connection"),!t.addTrack)return s.default.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");e.getTracks().forEach(function(n){t.addTrack(n,e)})},r.prototype._addStreamToMediaConnection=function(e,t){s.default.log("add stream "+e.id+" to media connection "+t.connectionId),t.addStream(e)},r}();exports.default=new d;
},{"reliable":"aYFJ","./util":"BHXf","./logger":"8WOs","./adapter":"sXtV","./enums":"9ZRY"}],"2JJl":[function(require,module,exports) {
...
"use strict";var t=this&&this.__extends||function(){var t=function(e,n){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n])})(e,n)};return function(e,n){function o(){this.constructor=e}t(e,n),e.prototype=null===n?Object.create(n):(o.prototype=n.prototype,new o)}}();Object.defineProperty(exports,"__esModule",{value:!0});var e=require("eventemitter3"),n=function(e){function n(t,n,o){var r=e.call(this)||this;return r.peer=t,r.provider=n,r.options=o,r._open=!1,r.metadata=o.metadata,r.connectionId=o.connectionId,r}return t(n,e),Object.defineProperty(n.prototype,"open",{get:function(){return this._open},enumerable:!0,configurable:!0}),n}(e.EventEmitter);exports.BaseConnection=n;
},{"eventemitter3":"2JJl"}],"dbHP":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(t,n)};return function(t,n){function o(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(o.prototype=n.prototype,new o)}}(),t=this&&this.__values||function(e){var t="function"==typeof Symbol&&e[Symbol.iterator],n=0;return t?t.call(e):{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}}},n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var o=require("./util"),r=n(require("./logger")),a=n(require("./negotiator")),i=require("./enums"),s=require("./baseconnection"),c=function(n){function s(e,t,r){var i=n.call(this,e,t,r)||this;return i._localStream=i.options._stream,i.connectionId=i.options.connectionId||s.ID_PREFIX+o.util.randomToken(),i._localStream&&a.default.startConnection(i,{_stream:i._localStream,originator:!0}),i}return e(s,n),Object.defineProperty(s.prototype,"type",{get:function(){return i.ConnectionType.Media},enumerable:!0,configurable:!0}),Object.defineProperty(s.prototype,"localStream",{get:function(){return this._localStream},enumerable:!0,configurable:!0}),Object.defineProperty(s.prototype,"remoteStream",{get:function(){return this._remoteStream},enumerable:!0,configurable:!0}),s.prototype.addStream=function(e){r.default.log("Receiving stream",e),this._remoteStream=e,n.prototype.emit.call(this,i.ConnectionEventType.Stream,e)},s.prototype.handleMessage=function(e){var t=e.type,n=e.payload;switch(e.type){case i.ServerMessageType.Answer:a.default.handleSDP(t,this,n.sdp),this._open=!0;break;case i.ServerMessageType.Candidate:a.default.handleCandidate(this,n.candidate);break;default:r.default.warn("Unrecognized message type:"+t+" from peer:"+this.peer)}},s.prototype.answer=function(e){var n,o;if(this._localStream)r.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");else{this.options._payload._stream=e,this._localStream=e,a.default.startConnection(this,this.options._payload);var i=this.provider._getMessages(this.connectionId);try{for(var s=t(i),c=s.next();!c.done;c=s.next()){var l=c.value;this.handleMessage(l)}}catch(u){n={error:u}}finally{try{c&&!c.done&&(o=s.return)&&o.call(s)}finally{if(n)throw n.error}}this._open=!0}},s.prototype.close=function(){this.open&&(this._open=!1,a.default.cleanup(this),n.prototype.emit.call(this,i.ConnectionEventType.Close))},s.ID_PREFIX="mc_",s}(s.BaseConnection);exports.MediaConnection=c;
},{"./util":"BHXf","./logger":"8WOs","./negotiator":"HCdX","./enums":"9ZRY","./baseconnection":"tQFK"}],"GBTQ":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(t,n)};return function(t,n){function i(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}(),t=this&&this.__values||function(e){var t="function"==typeof Symbol&&e[Symbol.iterator],n=0;return t?t.call(e):{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}}},n=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var r=require("reliable"),a=require("./util"),o=n(require("./logger")),s=i(require("./negotiator")),u=require("./enums"),l=require("./baseconnection"),f=function(n){function i(e,t,r){var o=n.call(this,e,t,r)||this;return o._buffer=[],o._bufferSize=0,o._buffering=!1,o._chunkedData={},o.connectionId=r.connectionId||i.ID_PREFIX+a.util.randomToken(),o.label=r.label||o.connectionId,o.serialization=r.serialization,o.reliable=r.reliable,r._payload&&(o._peerBrowser=r._payload.browser),s.default.startConnection(o,r._payload||{originator:!0}),o}return e(i,n),Object.defineProperty(i.prototype,"type",{get:function(){return u.ConnectionType.Data},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"dataChannel",{get:function(){return this._dc},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"bufferSize",{get:function(){return this._bufferSize},enumerable:!0,configurable:!0}),i.prototype.initialize=function(e){this._dc=e,this._configureDataChannel()},i.prototype._configureDataChannel=function(){var e=this;if(a.util.supports.sctp&&(this.dataChannel.binaryType="arraybuffer"),this.dataChannel.onopen=function(){o.default.log("Data channel connection success"),e._open=!0,e.emit(u.ConnectionEventType.Open)},!a.util.supports.sctp&&this.reliable){var t=o.default.logLevel>o.LogLevel.Disabled;this._reliable=new r.Reliable(this.dataChannel,t)}this._reliable?this._reliable.onmessage=function(t){e.emit(u.ConnectionEventType.Data,t)}:this.dataChannel.onmessage=function(t){e._handleDataMessage(t)},this.dataChannel.onclose=function(){o.default.log("DataChannel closed for:",e.peer),e.close()}},i.prototype._handleDataMessage=function(e){var t=this,i=e.data,r=i.constructor;if(this.serialization===u.SerializationType.Binary||this.serialization===u.SerializationType.BinaryUTF8){if(r===Blob)return void a.util.blobToArrayBuffer(i,function(e){i=a.util.unpack(e),t.emit(u.ConnectionEventType.Data,i)});if(r===ArrayBuffer)i=a.util.unpack(i);else if(r===String){var o=a.util.binaryStringToArrayBuffer(i);i=a.util.unpack(o)}}else this.serialization===u.SerializationType.JSON&&(i=JSON.parse(i));if(i.__peerData){var s=i.__peerData,l=this._chunkedData[s]||{data:[],count:0,total:i.total};return l.data[i.n]=i.data,l.count++,l.total===l.count&&(delete this._chunkedData[s],i=new Blob(l.data),this._handleDataMessage({data:i})),void(this._chunkedData[s]=l)}n.prototype.emit.call(this,u.ConnectionEventType.Data,i)},i.prototype.close=function(){this.open&&(this._open=!1,this._buffer=[],this._bufferSize=0,s.default.cleanup(this),n.prototype.emit.call(this,u.ConnectionEventType.Close))},i.prototype.send=function(e,t){var i=this;if(this.open)if(this._reliable)this._reliable.send(e);else if(this.serialization===u.SerializationType.JSON)this._bufferedSend(JSON.stringify(e));else if(this.serialization===u.SerializationType.Binary||this.serialization===u.SerializationType.BinaryUTF8){var r=a.util.pack(e);if((a.util.chunkedBrowsers[this._peerBrowser]||a.util.chunkedBrowsers[a.util.browser])&&!t&&r.size>a.util.chunkedMTU)return void this._sendChunks(r);a.util.supports.sctp?a.util.supports.binaryBlob?this._bufferedSend(r):a.util.blobToArrayBuffer(r,function(e){i._bufferedSend(e)}):a.util.blobToBinaryString(r,function(e){i._bufferedSend(e)})}else this._bufferedSend(e);else n.prototype.emit.call(this,u.ConnectionEventType.Error,new Error("Connection is not open. You should listen for the `open` event before sending messages."))},i.prototype._bufferedSend=function(e){!this._buffering&&this._trySend(e)||(this._buffer.push(e),this._bufferSize=this._buffer.length)},i.prototype._trySend=function(e){var t=this;if(!this.open)return!1;try{this.dataChannel.send(e)}catch(n){return this._buffering=!0,setTimeout(function(){t._buffering=!1,t._tryBuffer()},100),!1}return!0},i.prototype._tryBuffer=function(){if(this.open&&0!==this._buffer.length){var e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}},i.prototype._sendChunks=function(e){var n,i,r=a.util.chunk(e);try{for(var o=t(r),s=o.next();!s.done;s=o.next()){var u=s.value;this.send(u,!0)}}catch(l){n={error:l}}finally{try{s&&!s.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}},i.prototype.handleMessage=function(e){var t=e.payload;switch(e.type){case u.ServerMessageType.Answer:this._peerBrowser=t.browser,s.default.handleSDP(e.type,this,t.sdp);break;case u.ServerMessageType.Candidate:s.default.handleCandidate(this,t.candidate);break;default:o.default.warn("Unrecognized message type:",e.type,"from peer:",this.peer)}},i.ID_PREFIX="dc_",i}(l.BaseConnection);exports.DataConnection=f;
},{"reliable":"aYFJ","./util":"BHXf","./logger":"8WOs","./negotiator":"HCdX","./enums":"9ZRY","./baseconnection":"tQFK"}],"wJlv":[function(require,module,exports) {
...
},{"eventemitter3":"2JJl","./logger":"8WOs","./enums":"9ZRY"}],"in7L":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./util"),r=require("./mediaconnection"),t=require("./dataconnection"),n=require("./peer");exports.peerjs={MediaConnection:r.MediaConnection,DataConnection:t.DataConnection,Peer:n.Peer,util:e.util},exports.default=n.Peer,window.peerjs=exports.peerjs;
},{"./util":"BHXf","./mediaconnection":"dbHP","./dataconnection":"GBTQ","./peer":"Hxpd"}]},{},["iTK6"], null)
